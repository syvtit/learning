...
<br>B1: chạy c2_server.exe trên máy attacker, sau khi chạy xong thì server sẽ start dịch vụ web trên port 8000
...
<br>B5: để chạy file php, aspx thì dựng web server, sau đó mỗi lần cần kết nối+cần thực hiện lệnh thì truy cập từ attacker vào victim với url: http://<victim>/c2_client.php hoặc http://<victime>/c2_client.aspx
